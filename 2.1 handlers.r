...
{
	if (type == "Grand")
		animate_xy(x[VarIndex],grand_tour(), center=T,aps = speed_aps, axes = axes_location)
	if (type == "Little")
		animate_xy(x[VarIndex],little_tour(), aps = speed_aps, axes = axes_location)
